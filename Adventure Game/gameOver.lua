...
local function onRestartBtnRelease(self, event)
...
function scene:create( event )
	...
	local background = display.newImageRect( "gameover.jpg", display.contentWidth+70, display.contentHeight )
	background.anchorX = 0
	background.anchorY = 0
	background.x, background.y = -35, 0
	
	restartBtn = display.newImageRect( "restart.png", 64, 64 )
	restartBtn.width = 56
	restartBtn.height = 56
	restartBtn.anchorX = 0
	restartBtn.anchorY = 0
	restartBtn.x, restartBtn.y = 420, 262
	restartBtn.touch = onRestartBtnRelease
